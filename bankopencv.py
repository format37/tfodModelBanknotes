...
#file
#cap = cv2.VideoCapture("altkas2.avi")
			...
			if ret:				
				...
				if (objects_count>0):
					...
					if (eventdate!=lasteventdate):#save objectsPerMinute					
						...
						objectsPerTimeString	= '%.2f'%objectsPerTime
						print(eventdate+' - '+score_summ+' * '+objectsPerTimeString)
						f.write(eventdate+','+objectsPerTimeString+'\n')
